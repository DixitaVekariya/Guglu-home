...
const InputSection = () => {
  ...
  const getProvinceData = () => {
    axiosInstance
      .get("api/get-provinces/?per_page=100")
      .then((res) => {
  ...
  const getCityData = () => {
    axiosInstance
      .get("api/get-cities/666/?per_page=100")
      .then((res) => {
  ...
  const getPropertyData = () => {
    axiosInstance
      .get("api/property-types/?per_page=100")
      .then((res) => {
  ...
  const getOwenershipData = () => {
    axiosInstance
      .get("api/ownership-types/?per_page=100")
      .then((res) => {
  ...
  const List = [{ label: "Sale By owner" }, { label: "Listing Brokerage" }];
        ...
        <div className="inputChiledContainer">
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                ...
                id="unit-apt"
                fullWidth
                placeholder="Enter Unit/Apt No. Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.streetHouse}
                name="streetHouse"
                onChange={handleChange}
                id="street-house"
                fullWidth
                placeholder="Enter Street Name And House Number  Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                ...
                id="community-name"
                fullWidth
                placeholder="Enter Community Name Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.contryName}
                name="contryName"
                onChange={handleChange}
                id="contry-name"
                fullWidth
                placeholder="Enter Contry Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                ...
                id="postal-code"
                fullWidth
                placeholder="Enter Postal Code Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    value={state.fronting}
                    name="fronting"
                    onChange={handleChange}
                    {...params}
                    placeholder={"Select Fronting On*"}
                  />
                )}
              />
            </div>
        ...
        <div className="inputChiledContainer">
              ...
              <FormControl>
                ...
                >
                  <div>
                    <FormControlLabel
                      value="forSale"
                      control={<Radio style={{ color: "#0F2E1D" }} />}
                      label="for Sale"
                    />
                    <FormControlLabel
                      value="forRent"
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.taxeYear}
                name="taxeYear"
                onChange={handleChange}
                id="taxe-year"
                fullWidth
                placeholder="Enter Tax Year Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                ...
                id="assessment"
                fullWidth
                placeholder="Enter Assessment Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                ...
                id="assessment-year"
                fullWidth
                placeholder="Enter Assessment Year Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.specialDesignation}
                name="specialDesignation"
                onChange={handleChange}
                id="special-designation"
                fullWidth
                placeholder="Enter Special Designation Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                ...
                id="pool-type"
                fullWidth
                placeholder="Enter Pool Type Hear"
                variant="outlined"
              />
            </div>
          </div>
        ...
        <div className="chiledFormBtnContainer">
          <div className="saveBtnContainer">
            <Button variant="text" onClick={OnSaveBtnClick}>
              <span className="saveBtnText">SAVE & NEXT</span>
            </Button>
          </div>
          <div className="saveBtnContainer">
            <Button variant="text">
              <span className="saveBtnText">CANCEL</span>
            </Button>
          </div>
        </div>
      </div>
