        ...
        <div className="inputChiledContainer">
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.sizeTotal}
                name="sizeTotal"
                onChange={handleChange}
                id="size-total"
                fullWidth
                placeholder="Enter Size Total Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.sizeFront}
                name="sizeFront"
                onChange={handleChange}
                id="size-front"
                fullWidth
                placeholder="Enter Size Front Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.sizeDepth}
                name="sizeDepth"
                onChange={handleChange}
                id="size-depth"
                fullWidth
                placeholder="Enter Size Depth Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                ...
                id="access-type"
                fullWidth
                placeholder="Enter Access Type Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.landscapFeatures}
                name="landscapFeatures"
                onChange={handleChange}
                id="landscape-features"
                fullWidth
                placeholder="Enter Landscape features Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.lotFeatures}
                name="lotFeatures"
                onChange={handleChange}
                id="lot-features"
                fullWidth
                placeholder="Enter Lot Features Hear"
                variant="outlined"
              />
            </div>
          </div>
        ...
        <div className="inputChiledContainer">
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.extraFeatures}
                name="extraFeatures"
                onChange={handleChange}
                id="extra-features"
                fullWidth
                placeholder="Enter Extra Features Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                className="aptInput"
                value={state.sewerWater}
                name="sewerWater"
                onChange={handleChange}
                id="sewer-water"
                fullWidth
                placeholder="Enter Sewer/ Water Hear"
                variant="outlined"
              />
            </div>
          </div>
          ...
          <div className="aptInputContainer">
            ...
            <div className="inputAptContainer">
              <TextField
                ...
                id="appointments"
                fullWidth
                placeholder="Enter Appointments Hear"
                variant="outlined"
              />
            </div>
          </div>
      ...
      <div className="thiredFormBtnContainer">
        <div className="chiledsThiredFormBtnContainer">
          <div className="thiredSaveBtnContainer">
            <Button onClick={OnSaveBtnClick} variant="text">
              <span className="thiredSaveBtnText">SAVE & NEXT</span>
            </Button>
          </div>
          <div className="thiredSaveBtnContainer">
            <Button variant="text">
              <span className="thiredSaveBtnText">CANCEL</span>
            </Button>
          </div>
        </div>
      </div>
